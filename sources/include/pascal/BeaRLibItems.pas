...
function Ground_Clear_All(): Boolean; stdcall; external 'BeaRLibItems.dll';
function Ground_Count(MapID: Integer): Integer; stdcall; external 'BeaRLibItems.dll';
function Ground_Count_All(): Integer; stdcall; external 'BeaRLibItems.dll';
function Ground_Count_InTile(MapID: Integer; AX, AY: Integer): Integer; stdcall; external 'BeaRLibItems.dll';
function Ground_Item_By_Index(Index: Integer): TItem; stdcall; external 'BeaRLibItems.dll';
function Ground_Items(): TItems; stdcall; external 'BeaRLibItems.dll';
function Ground_Items_InTile(MapID: Integer; AX, AY: Integer): TItems; stdcall; external 'BeaRLibItems.dll';
function Ground_Items_Append(AItem: TItem): Boolean; stdcall; external 'BeaRLibItems.dll';
function Ground_Items_Delete(Index: Integer; var AItem: TItem): Boolean; stdcall; external 'BeaRLibItems.dll';
