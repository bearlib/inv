...
function Items_Ground_GetMapItems(MapID: Integer): TItems; stdcall; external 'BeaRLibItems.dll';
function Items_Ground_GetMapItemsXY(MapID: Integer; AX, AY: Integer): TItems; stdcall; external 'BeaRLibItems.dll';
