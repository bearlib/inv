...
function Ground_Items_Delete(Pos: Cardinal): TItem; stdcall;
function Ground_Items_Delete_InTile(Pos, AX, AY: Cardinal): TItem; stdcall;
...
function Ground_Items_Delete(Pos: Cardinal): TItem;
var
  I: Integer;
  FItem: TItem;
begin
...
function Ground_Items_Delete_InTile(Pos, AX, AY: Cardinal): TItem;
var
  I, J, P: Cardinal;
  FItem: TItem;
begin
